                ...
                <div className="header-area">
                    <div className="container">
                        <div className="wrap-header col-md-4">
                            <span className="st-logo"><a href="./index.html">SINH VIÊN VIỆT NAM</a></span>
                        </div>
                        <div className="wrap-header col-md-8">
                            <div className="header-menu float-right">
                                <ul>
                                    <li style={{ paddingLeft: '0px' }}><a href="#">Chia sẻ phòng trọ</a></li>
                                    <li><a href="#" className="link-active">Chia sẻ tài liệu</a></li>
                                    <li><a href="#">Việc làm sinh viên</a></li>
                                    <li><a href="#">Hỗ trợ</a></li>
                                    <li><a href="#" className data-toggle="modal" data-target="#exampleModal">Đăng nhập/ Đăng ký</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
